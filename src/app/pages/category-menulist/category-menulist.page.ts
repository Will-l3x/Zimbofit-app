...
@Component({
  selector: 'app-category-menulist',
  templateUrl: './category-menulist.page.html',
  styleUrls: ['./category-menulist.page.scss'],
})
export class CategoryMenulistPage implements OnInit, OnDestroy {
  public categories: any[];
  subscription: Subscription;
  viewed = false;
  page = 'Meal Plan Categories';
  appPages = [
    {
      title: 'Dashboard',
  ...
  sidenavOpen() {
    this.menu.enable(true, 'menu-content-cat-menu');
    this.menu.open('menu-content-cat-menu');
  }
  ngOnDestroy() {
